                                ...
                                <tr>
                                    <td>
                                        ...
                                        <h2 class="table-avatar">
                                            <a href="{{ url('employee/profile/'.$user->employeeId) }}" class="avatar"><img src="{{$user->avatar ? URL::to('/assets/images/employeePassport/'. $user->avatar) :  asset('assets/img/Circle-icons-profile.png') }}" alt="{{ $user->avatar }}"></a>
                                            <a href="{{ url('employee/profile/'.$user->employeeId) }}" class="name">{{ $user->name }}</span></a>
                                        </h2>
                                    </td>
                        ...
                        <form action="{{ route('user/add/save') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row"> 
                                ...
                                <div class="form-group">
                                        ...
                                        <input required  class="form-control @error('employeeId') is-invalid @enderror" type="text" id="" name="employeeId" value="{{ old('employeeId') }}" placeholder="Enter Employe eId">
                                    </div>
                                    </div>
                                <div class="col-sm-6"> 
                                    <div class="form-group">
                                        <label>Full Name</label>
                                        <input required  class="form-control @error('name') is-invalid @enderror" type="text" id="" name="name" value="{{ old('name') }}" placeholder="Enter Name">
                                    </div>
                                </div>
                                <div class="col-sm-6"> 
                                    <label>Emaill Address</label>
                                    <input required class="form-control" type="email" id="" name="email" placeholder="Enter Email">
                                </div>
                            </div>
                            <div class="row"> 
                                <div class="col-sm-6"> 
                                ...
                                <div class="col-sm-6"> 
                                    ...
                                    <select required class="select" name="position" id="position">
                                        <option selected disabled> --Select --</option>
                            ...
                            <div class="row"> 
                                <div class="col-sm-6"> 
                                    <div class="form-group">
                                        <label>Phone</label>
                                        <input required class="form-control" type="tel" id="" name="phone" placeholder="Enter Phone">
                                    </div>
                                </div>
                                <div class="col-sm-6"> 
                            ...
                            <div class="row"> 
                                ...
                                <div class="col-sm-6"> 
                                    ...
                                    <input required type="password" class="form-control" name="password_confirmation" placeholder="Choose Repeat Password">
                                </div>
                            </div>
