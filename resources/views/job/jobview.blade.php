        ...
        <div class="header">
            ...
            <div class="dropdown mobile-user-menu">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="dropdown-item" href="{{ route('registers') }}">Register</a>
                </div>
            </div>
            <!-- /Mobile Menu -->
                    ...
                    <div class="col-md-4">
                        <div class="job-det-info job-widget">
                            ...
                            <div class="info-list">
                                ...
                                <h5>Salary</h5>
                                <p>GHS {{ $job_view[0]->salary_from }} - GHS {{ $job_view[0]->salary_to }}</p>
                            </div>
                            <div class="info-list">
                            ...
                            @php
                            $start_date =  Carbon\Carbon::parse($job_view[0]->start_date); 
                            $expired_date =  Carbon\Carbon::parse($job_view[0]->expired_date); 
                            $day     = $start_date->diff($expired_date );
                            $days    = $day->d;

                            // $elapsed =  $date->diffForHumans();
                        @endphp
                            <div class="info-list text-center">
                                <a class="app-ends" href="#">Application ends in {{ $days }} days</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="modal-body">
                            <form action="{{ route('form/apply/job/save') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input @error('cover_upload') is-invalid @enderror" id="cover_upload" name="cover_upload">
                                        <label class="custom-file-label" for="cover_upload">Choose file</label>
                                    </div>
                                </div>
