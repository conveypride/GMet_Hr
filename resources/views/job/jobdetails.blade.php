                    ...
                    <div class="job-info job-widget">
                        ...
                        <ul class="job-post-det">
                            ...
                            <li><i class="fa fa-eye"></i> Views: <span class="text-blue">
                                @if (!empty($job_view_detail[0]->count))
                                {{ $job_view_detail[0]->count }}
                                @else
                                0
                            @endif    
                            </span></li>
                ...
                <div class="col-md-4">
                    <div class="job-det-info job-widget">
                        ...
                        <div class="info-list">
                            ...
                            <h5>Salary</h5>
                            <p>GHS  {{ $job_view_detail[0]->salary_from }} - GHS {{ $job_view_detail[0]->salary_to }}</p>
                        </div>
                        <div class="info-list">
                        ...
                        @php
                        $start_date =  Carbon\Carbon::parse($job_view_detail[0]->start_date); 
                        $expired_date =  Carbon\Carbon::parse($job_view_detail[0]->expired_date); 
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="{{ $job_view_detail[0]->job_title }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="{{ $job_view_detail[0]->job_location }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
