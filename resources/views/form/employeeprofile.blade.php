                            ...
                            <div class="profile-view">
                                <div class="profile-img-wrap">
                                    <div class="profile-img">
                                        <a href="#"><img alt="" src="{{ URL::to('/assets/images/employeePassport/'. $user[0]->avatar) }}" alt="{{ $user[0]->name }}"></a>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                ...
                                                <h6 class="text-muted">Department: {{ $user[0]->department }}</h6>
                                                <small class="text-muted">Position: {{ $user[0]->position }}</small>
                                                <div class="staff-id">Employee ID: {{ $user[0]->employeeId }}</div>
                                                <div class="small doj text-muted">Date Joined : {{ $user[0]->join_date }}</div>
                        ...
                        <div class="col-md-6 d-flex">
                            <div class="card profile-box flex-fill">
                                <div class="card-body">
                                    ...
                                    <ul class="personal-info">
                                        <li>
                                            <div class="title">Gh-Card No.</div>
                                            <div class="text">{{ $users->passport_no }}</div>
                                        </li>
                                        <li>
                                            <div class="title">Gh-Card Exp Date.</div>
                                        ...
                                        <li>
                                            ...
                                            <div class="text">{{ $users->hometown }}</div>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <div class="title">Marital Date</div>
                                            @if (!empty( $users->maritalDate))
                                            <div class="text">{{ $users->maritalDate }}</div>
                                            @else
                                            <div class="text">N/A</div>
                                            @endif
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="project-members m-b-15">
                                        ...
                                        <ul class="team-members">
                                            <li>
                                                <a href="#" data-toggle="tooltip" title="Jeffery Lalor"><img alt="" src="{{ asset('assets/img/Circle-icons-profile.png')}}"></a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="project-members m-b-15">
                                        ...
                                        <ul class="team-members">
                                            <li>
                                                <a href="#" data-toggle="tooltip" title="John Doe"><img alt="" src="{{ asset('assets/img/Circle-icons-profile.png')}}"></a>
                                            </li>
                                            <li>
                                                <a href="#" data-toggle="tooltip" title="Richard Miles"><img alt="" src="{{ asset('assets/img/Circle-icons-profile.png')}}"></a>
                                            </li>
                                            <li>
                                                <a href="#" data-toggle="tooltip" title="John Smith"><img alt="" src="{{ asset('assets/img/Circle-icons-profile.png')}}"></a>
                                            </li>
                                            <li>
                                                <a href="#" data-toggle="tooltip" title="Mike Litorus"><img alt="" src="{{ asset('assets/img/Circle-icons-profile.png')}}"></a>
                                            </li>
                                            <li>
                    ...
                    <div class="modal-body">
                        <form action="{{ route('profile/information/save') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="profile-img-wrap edit-img">
                                        <img class="inline-block" src="{{ URL::to('/assets/images/employeePassport/'. $user[0]->avatar) }}" alt="{{ $user[0]->name }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" class="form-control" id="user_id" name="user_id" value="{{ $user[0]->employeeId }}">
                            ...
                            <div class="row">
                                ...
                                <option value="{{ $items->department }}">{{ $items->department }}</option>
                                    @endforeach
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select" id="designation" name="designation">
                                            @if(!empty($users))
                                                ...
                                                <option value="{{ $items->designation }}">{{ $items->designation }}</option>
                                                    @endforeach
                                            @else
                                            @foreach ($designations as $key=>$items )
                                                <option value="{{ $items->designation }}">{{ $items->designation }}</option>
                                        ...
                                        <select class="select" id="" name="reports_to">
                                            @if(!empty($users))
                                                <option value="{{ $users->reports_to }}" {{ ( $users->reports_to == $users->reports_to) ? 'selected' : '' }}>{{ $users->reports_to }} </option>
                                                    ...
                                                    <option value="{{ $userss->name }}">{{ $userss->name }}</option>
                                                @endforeach
                                            @else
                                                @foreach ($allusers as $userss )
                                                    <option value="{{ $userss->name }}">{{ $userss->name }}</option>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('user/information/save') }}" method="POST">
                            @csrf
                            <input type="hidden" class="form-control" name="user_id" value="{{ $users->employeeId }}" readonly>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Gh-Card Expiry Date</label>
                                        <div class="cal-icon">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input class="form-control @error('hometown') is-invalid @enderror" type="text" name="hometown" value="{{ $users->hometown }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('Marital_Date') is-invalid @enderror" type="date" name="maritalDate" value="{{ $users->maritalDate }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
