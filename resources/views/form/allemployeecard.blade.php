            ...
            <div class="row staff-grid-row">
                ...
                <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                    <div class="profile-widget">
                        ...
                        @if($lists->verifiedprofile != "Deleted")
                        <div class="dropdown profile-action">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item" href="{{url('all/employee/viewchanges/'.$lists->employeeId)}}" ><i class="fa fa-trash-o m-r-5"></i> View Changes</a>
                                @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select select2s-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" id="name" name="name">
                                            ...
                                            @foreach ($userList as $key=>$user )
                                                <option value="{{ $user->name }}" data-employee_id={{ $user->employeeId }} data-email={{ $user->email }}>{{ $user->name }}</option>
                                               @endforeach
