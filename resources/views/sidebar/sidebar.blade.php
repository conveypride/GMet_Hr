...
<div class="sidebar" id="sidebar">
            ...
            <ul>
                ...
                <li class="{{set_active(['home','em/dashboard'])}} submenu">
                    ...
                    <ul style="{{ request()->is('/*') ? 'display: block;' : 'display: none;' }}">
                        ...
                        <li><a class="{{set_active(['adm/home'])}}" href="{{ route('adm/home') }}">Admin Dashboard</a></li>
                ...
                @if (Auth::user()->role_name=='Super Admin')
                    ...
                    <li class="{{set_active(['search/user/list','userManagement','activity/login/logout'])}} submenu">
                        <a href="#" class="{{ set_active(['search/user/list','userManagement','activity/login/logout']) ? 'noti-dot' : '' }}">
                ...
                <li class="{{set_active(['all/employee/list','all/employee/list','all/employee/card','form/holidays/new','form/leaves/new',
                    'form/leavesemployee/new','form/leavesettings/page/',
                    'attendance/employee/page','form/departments/page','form/designations/page',
                    'form/task/page','form/shiftscheduling/page','form/overtime/page'])}} submenu">
                    <a href="#" class="{{ set_active(['all/employee/list','all/employee/card','form/holidays/new','form/leaves/new','form/leavesemployee/new','form/leavesettings/page/',
                    'attendance/employee/page','form/departments/page','form/designations/page',
                    'form/task/page','form/shiftscheduling/page','form/overtime/page']) ? 'noti-dot' : '' }}">
                    ...
                    <ul style="{{ request()->is('/*') ? 'display: block;' : 'display: none;' }}">
                        ...
                        @if (Auth::user()->role_name == 'Super Admin')
                        <li><a class="{{set_active(['all/employee/awaitingApproval'])}}" href="{{ route('all/employee/awaitingApproval') }}">Awaiting Approval
                        ...
                        <li><a class="{{set_active(['form/leavesettings/page/'])}}" href="{{ route('form/leavesettings/page/', ['id' => 'junior']) }}">Leave Settings</a></li>
                        ...
                        {{-- <li><a class="{{set_active(['form/task/page'])}}" href="{{ route('form/task/page') }}">Assign Task</a></li> --}}
                ...
                <li class="menu-title"> <span> @if (Auth::user()->role_name=='Admin'  || Auth::user()->role_name=='Super Admin')HR  @endif</span> </li>
    ...
    <li class="{{set_active(['form/expense/reports/page','form/invoice/reports/page','form/leave/reports/page','form/daily/reports/page','attendance/page'])}} submenu">
        <a href="#" class="{{ set_active(['form/expense/reports/page','form/invoice/reports/page','form/leave/reports/page','form/daily/reports/page', 'attendance/page']) ? 'noti-dot' : '' }}"><i class="la la-pie-chart"></i>
...
@endif
            ...
            <li><a class="{{set_active(['attendance/page'])}}" href="{{ route('attendance/page') }}">Attendance Report</a></li>
...
@if (Auth::user()->role_name=='Super Admin')
<li class="{{set_active(['user/dashboard/index','jobs/dashboard/index','user/dashboard/all','user/dashboard/applied/jobs','user/dashboard/interviewing','user/dashboard/offered/jobs','user/dashboard/visited/jobs','user/dashboard/archived/jobs','user/dashboard/save','jobs','job/applicants','job/details','job/interview/panel','page/manage/resumes','page/shortlist/candidates','page/interview/questions','page/interview/menu','page/offer/approvals','page/experience/level','page/candidates','page/schedule/timing','page/aptitude/result'])}} submenu">
    ...
    <ul style="{{ request()->is('/*') ? 'display: block;' : 'display: none;' }} {{ (request()->is('job/applicants/*')) ? 'display: block;' : 'display: none;' }}">
        ...
        <li><a class="{{set_active(['page/manage/resumes'])}}" href="{{ route('page/manage/resumes') }}"> Manage Applicants </a></li>
        <li><a class="{{set_active(['page/shortlist/candidates'])}}" href="{{ route('page/shortlist/candidates') }}"> Shortlist Candidates </a></li>
        <li><a class="{{set_active(['page/interview/menu'])}}" href="{{ route('page/interview/menu') }}">Interview Menu </a></li>
        <li><a class="{{set_active(['job/interview/panel','job/interview/panel'])}}" href="{{ route('job/interview/panel') }} "> Manage Interview-Panel </a></li>
