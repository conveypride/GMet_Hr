		...
		<div class="header">
			...
			<div class="header-left">
				<a href="{{ route('home') }}" class="logo">
					<img class="rounded-lg" src="{{ URL::to('/assets/images/employeePassport/'. Auth::user()->avatar) }}" width="40" height="40" alt="">
				</a>
			</div>
			<!-- /Logo -->
			...
			<ul class="nav user-menu">
							...
							<ul class="notification-list">
								<li class="notification-message">
									<a href="activities.html">
										<div class="media">
											<span class="avatar">
												<img alt="" src="{{ URL::to('/assets/images/employeePassport/'.Auth::user()->avatar) }}">
											</span>
				...
				<li class="nav-item dropdown has-arrow main-drop">
					...
					<div class="dropdown-menu">
						...
						@endif
						<a class="dropdown-item" href="{{ route('logoutt') }}">Logout</a>
					</div>
				</li>
			</ul>
			<!-- /Header Menu -->
