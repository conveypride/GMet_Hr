                    ...
                    <div class="card dash-widget">
                        <div class="card-body"> <span class="dash-widget-icon"><i class="fa fa-users"></i></span>
                            <div class="dash-widget-info">
                                <h3>{{ $pendingapplicants }}</h3> <span>Pending Job Applicants</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                    <div class="card dash-widget">
                        <div class="card-body"> <span class="dash-widget-icon"><i class="fa fa-briefcase"></i></span>
                            <div class="dash-widget-info">
                                <h3>{{ $employeesOnLeave }}</h3> <span>Employees On Leave</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-6 text-center">
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="card-title">Employees Salary Overview</h3>
                        ...
                        <div class="col-md-6 text-center">
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="card-title">Present vs Absent Employees</h3>
                    ...
                    <div class="card-group m-b-30">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="mb-0">Overall Employees 7018</p>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="client-profile.html" class="avatar">
                                                        <img alt="" src="{{ asset('assets/img/Circle-icons-profile.png')}}">
                                                    </a>
