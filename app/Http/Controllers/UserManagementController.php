...
class UserManagementController extends Controller
{
    ...
    {
        $activityLog = DB::table('activity_logs')->orderBy('date_time', 'desc')->get();
            ...
            if(!empty($request->images))
            {
                ...
                if($image_name =='photo_defaults.png')
                {
                    if($image != '')
                    {
                        ...
                        $image->move(public_path('/assets/images/employeePassport/'), $image_name);
                    }
                } else {
                    if($image != '')
                    {
                        $image_name = rand() . '.' . $image->getClientOriginalExtension();
                        $image->move(public_path('/assets/images/employeePassport/'), $image_name);
                        unlink('/assets/images/employeePassport/'.Auth::user()->avatar);
                    }
                }
                $update = [
                ...
                User::where('employeeId',$request->user_id)->update($update);
            } 
...
$updatedColumns =  $information ->trackUpdatedColumns($request->all());
...
$activityLog = ['name'=> Session::get('name'),'email'=> Session::get('email'),'description' => 'Updated employee '.$request->user_id.' profile infomation: '.json_encode($updatedColumns).'','date_time'=> $todayDate,];
// Log::info(json_encode($activityLog));
 DB::table('activity_logs')->insert($activityLog);
    ...
    public function addNewUserSave(Request $request)
    {
        ...
        try{
            ...
            $request->image->move(public_path('/assets/images/employeePassport/'), $image);
            ...
            $activityLog = ['name'=> Auth::user()->name,'email'=>  Auth::user()->email,'description' => 'Registered New User '.$request->employeeId.' Registration Details: '.json_encode($usedatails).'','date_time'=> $todayDate]; 
            // Log::info(json_encode($activityLog));
             DB::table('activity_logs')->insert($activityLog);
    ...
    public function update(Request $request)
    {
        ...
        try{
            ...
            if($image_name =='photo_defaults.png')
            {
                ...
                if($image != '')
                {
                    // unlink('/assets/images/employeePassport/'.$image_name);
                    $image_name = rand() . '.' . $image->getClientOriginalExtension();
                    $image->move(public_path('/assets/images/employeePassport/'), $image_name);
                }
            }
    ...
    public function delete(Request $request)
    {
        ...
        try{
            ...
            if($request->avatar =='photo_defaults.png'){
                ...
                User::destroy($request->id);
                unlink('/assets/images/employeePassport/'.$request->avatar);
            }
            DB::commit();
