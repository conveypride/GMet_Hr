...
use App\Http\Controllers\Panelmember;
...
// ---------------panel members--------------------------------------------------------
Route::controller(Panelmember::class)->group(function () {
    Route::get('panel/dashboard', 'paneldashboard')->name('panel/dashboard');
    Route::get('panel/interviewform', 'interviewform')->name('panel/interviewform');
...
Route::controller(LoginController::class)->group(function () {
    ...
    Route::get('/panellogin', 'panellogin')->name('panellogin');
...
Route::controller(ForgotPasswordController::class)->group(function () {
    ...
    Route::post('forget-password', 'postEmail')->name('forget-passwordt');    
});
...
Route::controller(JobController::class)->group(function () {
    Route::get('changejobapplicantStatus/{id}/{name}','changejobapplicantStatus')->name('changejobapplicantStatus');
    Route::get('/','jobIndex')->name('/');
    Route::post('all/applicants/search', 'applicantsSearch')->name('all/applicants/search');
    Route::get('all/applicants/search', 'applicantsSearch');
    Route::post('schduleinterview', 'schduleinterview')->name('schduleinterview');
    
Route::post('all/shortlistedapplicants/search', 'shortlistapplicantsSearch')->name('all/shortlistedapplicants/search');
    Route::get('all/shortlistedapplicants/search', 'shortlistapplicantsSearch');
    ...
    Route::get('job/interview/panel', 'getpanelmembers')->middleware('auth')->name('job/interview/panel');
    Route::post('job/interview/panels', 'addpanelmembers')->middleware('auth')->name('job/interview/panels');
    Route::post('generatenewpass','generatenewpass')->name('generatenewpass');

    Route::get('job/details/{id}', 'jobDetails')->middleware('auth');
    Route::get('cv/download/{id}', 'downloadCV')->middleware('auth');
    Route::get('cover/download/{id}', 'downloadcover')->middleware('auth');
    ...
    Route::get('page/manage/resumes', 'manageApplicants')->middleware('auth')->name('page/manage/resumes');
    ...
    Route::get('page/interview/menu', 'interviewmenuIndex')->middleware('auth')->name('page/interview/menu');
     // view page
...
Route::controller(EmployeeController::class)->group(function () {
    ...
    Route::get('all/employee/viewchanges/{employee_id}', 'viewChanges')->middleware('auth');
    Route::post('all/employee/editemployeeApproval/{employee_id}', 'editemployeeApproval')->middleware('auth');
    
    Route::get('all/employee/addnew', 'addnew')->middleware('auth')->name('all/employee/addnew');;
    Route::post('all/employee/addnew', 'addnewEmployee');
    ...
    Route::post('all/employee/list/search', 'employeeListSearch')->middleware('auth')->name('all/employee/list/search');
    Route::get('all/employee/awaitingApproval', 'awaitingApprovalView')->middleware('auth')->name('all/employee/awaitingApproval');
    Route::post('all/employee/postApprove', 'postApprove')->middleware('auth')->name('all/employee/postApprove');
    ...
    Route::get('form/task/page', 'taskIndex')->middleware('auth')->name('form/task/page');    
    Route::post('form/task/save', 'saveRecordtasks')->middleware('auth')->name('form/task/save');    
    Route::post('form/task/update', 'updateRecordtasks')->middleware('auth')->name('form/task/update');    
    Route::post('form/task/delete', 'deleteRecordtasks')->middleware('auth')->name('form/task/delete');
...
// 
  Route::post('form/designation/save', 'designmentsave')->middleware('auth')->name('form/designation/save');   
...
Route::controller(LeavesController::class)->group(function () {
    ...
    Route::post('form/leavesettings/page/form/leavesemployee/save', 'save')->middleware('auth')->name('form/leavesemployee/save');
    
Route::post('form/leavesemployee/{id}', 'approveorreject')->middleware('auth');
...
// ----------------------------- form attendance  ------------------------------//
Route::controller(LeavesController::class)->group(function () {
    Route::get('form/leavesettings/page/{id}', 'leaveSettings')->middleware('auth')->name('form/leavesettings/page/');
...
Route::controller(ExpenseReportsController::class)->group(function () {
    ...
    Route::post('/form/leave/reports/{id}', 'approveorreject')->middleware('auth');
});
...
Route::controller(SalesController::class)->group(function () {
    ...
    Route::post('expenses/delete', 'deleteRecord')->middleware('auth')->name('expenses/delete');
        // ---------------------- search expenses  ---------------//
    Route::get('expenses/search', 'searchRecord')->middleware('auth');
